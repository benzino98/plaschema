...
@section('content')
        ...
        <div class="container-custom">
            <div class="text-center max-w-4xl mx-auto">
                ...
                @if($provider->category)
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-plaschema text-white mb-6 slide-up">
                        {{ $provider->category }}
                    </span>
                @endif
    ...
    <x-section>
        <div class="max-w-6xl mx-auto">
            <div class="mb-6">
                <a href="{{ route('providers.index') }}" class="text-plaschema hover:underline flex items-center">
                    ...
                    <div class="bg-white rounded-lg shadow p-6 mb-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start">
                                <svg class="w-5 h-5 text-plaschema mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex items-center">
                                <svg class="w-5 h-5 text-plaschema mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex items-center">
                                ...
                                <a href="mailto:{{ $provider->email }}" class="text-plaschema hover:underline">{{ $provider->email }}</a>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center">
                                ...
                                <a href="{{ $provider->website }}" target="_blank" class="text-plaschema hover:underline">Visit Website</a>
                            </div>
                            @endif
                        </div>
                    </div>

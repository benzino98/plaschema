                    ...
                    <div class="flex justify-between h-20">
                        ...
                        <div class="hidden sm:flex sm:items-center">
                            <div class="flex space-x-4 md:space-x-6">
                                <a href="{{ route('home') }}" class="inline-flex items-center px-2 pt-1 border-b-2 {{ request()->routeIs('home') ? 'border-plaschema' : 'border-transparent' }} text-base font-medium leading-5 text-gray-900 hover:text-plaschema hover:border-plaschema transition hover-lift nav-hover-glow">Home</a>
                                <a href="{{ route('about') }}" class="inline-flex items-center px-2 pt-1 border-b-2 {{ request()->routeIs('about') ? 'border-plaschema' : 'border-transparent' }} text-base font-medium leading-5 text-gray-900 hover:text-plaschema hover:border-plaschema transition hover-lift nav-hover-glow">About</a>
                                <a href="{{ route('plans') }}" class="inline-flex items-center px-2 pt-1 border-b-2 {{ request()->routeIs('plans') ? 'border-plaschema' : 'border-transparent' }} text-base font-medium leading-5 text-gray-900 hover:text-plaschema hover:border-plaschema transition hover-lift nav-hover-glow">Health Plans</a>
                                <a href="{{ route('providers.index') }}" class="inline-flex items-center px-2 pt-1 border-b-2 {{ request()->routeIs('providers.*') ? 'border-plaschema' : 'border-transparent' }} text-base font-medium leading-5 text-gray-900 hover:text-plaschema hover:border-plaschema transition hover-lift nav-hover-glow">Providers</a>
                                <a href="{{ route('news') }}" class="inline-flex items-center px-2 pt-1 border-b-2 {{ request()->routeIs('news*') ? 'border-plaschema' : 'border-transparent' }} text-base font-medium leading-5 text-gray-900 hover:text-plaschema hover:border-plaschema transition hover-lift nav-hover-glow">News</a>
                                <a href="{{ route('resources.index') }}" class="inline-flex items-center px-2 pt-1 border-b-2 {{ request()->routeIs('resources.*') ? 'border-plaschema' : 'border-transparent' }} text-base font-medium leading-5 text-gray-900 hover:text-plaschema hover:border-plaschema transition hover-lift nav-hover-glow">Resources</a>
                                <a href="{{ route('faq') }}" class="inline-flex items-center px-2 pt-1 border-b-2 {{ request()->routeIs('faq') ? 'border-plaschema' : 'border-transparent' }} text-base font-medium leading-5 text-gray-900 hover:text-plaschema hover:border-plaschema transition hover-lift nav-hover-glow">FAQs</a>
                                <a href="{{ route('contact') }}" class="inline-flex items-center px-2 pt-1 border-b-2 {{ request()->routeIs('contact') ? 'border-plaschema' : 'border-transparent' }} text-base font-medium leading-5 text-gray-900 hover:text-plaschema hover:border-plaschema transition hover-lift nav-hover-glow">Contact</a>
                                <x-language-switcher />
                            </div>
                        </div>

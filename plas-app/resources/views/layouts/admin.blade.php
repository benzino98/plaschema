        ...
        <div class="flex">
            ...
            <div id="sidebar" class="bg-gray-900 text-white w-64 flex-shrink-0 fixed h-screen overflow-y-auto">
                ...
                <nav class="mt-4">
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 flex items-center space-x-3 text-gray-300 hover:bg-gray-800 rounded {{ request()->routeIs('admin.dashboard', 'admin.index') ? 'bg-gray-800 text-white' : '' }}">

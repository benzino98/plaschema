...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-semibold text-gray-900">Role Activity Logs</h1>
            <a href="{{ route('admin.roles.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-2 px-4 rounded text-sm flex items-center">
        ...
        <div class="mt-6 bg-white shadow rounded-lg">
            ...
            <div class="p-4 border-b border-gray-200">
                ...
                <form action="{{ route('admin.roles.activity') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                    No activity logs found for roles.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
